...
**IMPORTANT: Write Tool Constraint**
You may ONLY use the Write tool to create markdown files (*.md) for recording your review findings. You MUST NEVER use Write to create or modify production code, test code, or any non-markdown file.
